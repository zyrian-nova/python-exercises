"""
Write a program that calculates the average of three test scores and assigns a grade based 
on the result.
Requirements:
...
# f"{average:.2f}" limits the average to two decimal places for better readability.
if average >= 90:
    print("Grade: A")
elif average >= 80:
    print("Grade: B")
